...
- **Interactions (Updated Phase 5/6):**
  ...
  - **Universal Swipe (Unified):** Swipe Right (Complete) or Left (Reschedule) on ANY visible task (Past, Now, or Next). This applies to both **Mobile** (touch) and **Web** (mouse drag/trackpad).
  - **Details:** Click/Tap any task to view full details (Read-only).
...
- **AC-PRESENT-3:** Swipe actions work on all visible tasks.
...
- **AC-ME-5:** User can view a "Logs" section showing recent completion feedback.
